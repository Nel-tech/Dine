...
function Services() {
  return (
    <section className="py-[10rem] ">
      <h1 className="text-center text-3xl font-bold pb-[6rem] xs:text-[1.2rem] mobile:text-[1.2rem]">We Provide the Best Services</h1>

      <main className=" px-[3rem] flex justify-between self-center content-center xs:flex-col mobile:flex-col tablet:flex-col tablet:mx-auto">
        
        <div className="text-center xs:pb-[.9rem] mobile:pb-[.9rem] tablet:pb-[.9rem]">
          ...
          <p className="text-[#333333] mt-2 xs:text-[.9rem] xs:max-w-[15rem] xs:mx-auto tablet:max-w-[25rem] tablet:mx-auto">
        ...
        <div className="text-center xs:pb-[.9rem] sm:pb-[.9rem] tablet:pb-[.9rem]">
          <div className="w-[4.5rem] h-[4.5rem] rounded-full border-[5px] border-[#AD343E] flex items-center justify-center mx-auto">
            <div className="w-[3.5rem] h-[3.5rem] rounded-full bg-[#AD343E] flex items-center justify-center">
